---- MODULE SubstrateResilience_TTrace_1773598744 ----
...
_prop ==
    ~(([]<>(
            ...
            substrate = ("Down")
            /\
            status = ([RUNPLAN |-> "Ready", WATCHTREE |-> "Pending", RETRY1 |-> "Ready", RETRY2 |-> "Pending"])
    ))/\([]<>(
            agent = ([RUNPLAN |-> FALSE, WATCHTREE |-> FALSE, RETRY1 |-> FALSE, RETRY2 |-> FALSE])
            /\
            substrate = ("Up")
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SubstrateResilience_TTrace_1773598744.json", _TETrace)
...
\*
\*trace == IODeserialize("SubstrateResilience_TTrace_1773598744.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([agent |-> [RUNPLAN |-> FALSE, WATCHTREE |-> FALSE, RETRY1 |-> FALSE, RETRY2 |-> FALSE],substrate |-> "Up",status |-> [RUNPLAN |-> "Pending", WATCHTREE |-> "Pending", RETRY1 |-> "Ready", RETRY2 |-> "Pending"]]),
    ...
    ([agent |-> [RUNPLAN |-> FALSE, WATCHTREE |-> FALSE, RETRY1 |-> FALSE, RETRY2 |-> FALSE],substrate |-> "Down",status |-> [RUNPLAN |-> "Ready", WATCHTREE |-> "Pending", RETRY1 |-> "Ready", RETRY2 |-> "Pending"]])
    >>
----
...
---- CONFIG SubstrateResilience_TTrace_1773598744 ----
CONSTANTS
    UseRecovery = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Mar 15 18:19:05 GMT 2026