---- MODULE SubstrateResilience_TTrace_1773598694 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SubstrateResilience_TTrace_1773598694.json", _TETrace)
...
\*
\*trace == IODeserialize("SubstrateResilience_TTrace_1773598694.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG SubstrateResilience_TTrace_1773598694 ----
CONSTANTS
    UseRecovery = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Mar 15 18:18:14 GMT 2026