---- MODULE SubstrateResilience_TTrace_1773598798 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SubstrateResilience_TTrace_1773598798.json", _TETrace)
...
\*
\*trace == IODeserialize("SubstrateResilience_TTrace_1773598798.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG SubstrateResilience_TTrace_1773598798 ----
CONSTANTS
    UseRecovery = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Mar 15 18:19:59 GMT 2026