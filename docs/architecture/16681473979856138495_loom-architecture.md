...
> **SUPERSEDED**: This design doc predates the current implementation. "Loom" was implemented as **Arbor** (`src/activations/arbor/`). The handle-based, source-agnostic design described here was preserved in Arbor. See `16671569470654229502_activation-integration.md` for the current architecture.
