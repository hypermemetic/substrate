...
```bash
<<<<<<< HEAD
synapse substrate cone chat --identifier.type by_name --identifier.name haiku35 --prompt "hi"
=======
synapse plexus cone chat --identifier.type by_name --identifier.name haiku35 --prompt "hi"
>>>>>>> 8d2c9810 (docs: add IR-based CLI implementation summary)
...
```bash
<<<<<<< HEAD
synapse substrate cone chat --identifier.type by_name --identifier.name haiku --prompt "hi"
=======
...
- `/Users/user/dev/controlflow/hypermemetic/synapse-cli-from-ir/src/Synapse/CLI/Help.hs`
- `/Users/user/dev/controlflow/hypermemetic/synapse-cli-from-ir/src/Synapse/CLI/Parse.hs`
- `/Users/user/dev/controlflow/hypermemetic/synapse-cli-from-ir/src/Synapse/CLI/Support.hs`
- `/Users/user/dev/controlflow/hypermemetic/synapse-cli-from-ir/src/Synapse/IR/Types.hs`
- `/Users/user/dev/controlflow/hypermemetic/synapse-cli-from-ir/src/Synapse/IR/Builder.hs`
- `/Users/user/dev/controlflow/hypermemetic/synapse-cli-from-ir/test/IRSpec.hs`
